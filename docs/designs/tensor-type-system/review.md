...
- `docs/designs/tensor-type-system/01-architecture.md` — Full architectural design
- `docs/designs/tensor-type-system/frontend-1-tensortypes.md` — Type model spec
- `docs/designs/tensor-type-system/frontend-2-stereotype-json.md` — Stereotype extension spec
- `docs/designs/tensor-type-system/frontend-3-typeEngine.md` — Engine algorithm spec
- `docs/designs/tensor-type-system/frontend-4-typeEngine-test.md` — Test spec
